// ============================================================================
//  Sentinel Node Oracle - CLI face
//  Calls the core and prints a connection plan. The core does the thinking.
//
//  Usage: node cli.js "Germany"
//         node cli.js "Iran"
// ============================================================================
...
async function main() {
  ...
  if (!country) {
    ...
    console.log("Try:   node cli.js \"Germany\"   or   \"Iran\"\n");
    return;
  }
  ...
  if (!r.primary) { console.log(`\nNo usable node found (not even via neighbours).\n`); return; }
